$(document).ready(function() {
  ...
  "1. For the disease MALARIA the most accurate antibiotic would be ","2. Choose the suitable antibiotic for the patient suffering from the common disease ATHLETE’S FOOT ",
  "3. A serious bacterial infection which can be spread easily such as DIPHTHERIA can be treated with?","Guess this structure - C22H24N2O8","Guess this structure - C18H14Cl4N2O","Guess this structure - C37H67NO13"]
  var choices = [
    ...
    ["a. Doxycycline","b.Amoxicillin" , "c.Vibramycin","d.Penicillin"],
    ["a.Zestril","b.Miconazole","c.Glucophage","d.Quinidine"],
    ["a.Doxycyclin","b.Glucophage","c.Erythromycin","d.Adoxa"]
  ]
  var answers = [2,4,1,4,3,1,1,2,3];
